    ...
    promptAnswers = await inquirer.prompt([
        {
            name: 'department',
            type: 'list',
            message: "\nSelect the department that you would like to remove?",
            choices: departments
        }
    ]);
    ...
    promptAnswers = await inquirer.prompt([
        {
            name: 'title',
            type: 'list',
            message: "\nSelect the role that you would like to remove?",
            choices: titles
        }
    ]);
    ...
    promptAnswers = await inquirer.prompt([
        {
            name: 'employee',
            type: 'list',
            message: "\nSelect the employee to update the role",
            choices: employees.map(employee => employee.full_name)
        },
        {
            name: 'title',
    ...
    promptAnswers = await inquirer.prompt([
        {
            name: 'employee',
            type: 'list',
            message: "\nSelect the employee to update the manager",
            choices: employees.map(employee => employee.full_name)
        },
        {
            name: 'Manager',
